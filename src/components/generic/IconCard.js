    ...
    return (
        <div className={`${props.isDesktop ? 'desktopIconCardContainer' : 'mobileIconCardContainer'} width-full`}>
            <div className="test">
                ...
                <div className={`iconCardTitle font-header text-grey-light font-bold text-3xl ${props.isDesktop ? 'text-4xl mb-6' : 'text-3xl mb-4'}`}>
                    <p>{props.title}</p>
                </div>
                <div className={`iconCardBody font-body text-grey-light text-left mx-6 ${props.isDesktop ? 'text-lg' : ''}`}>
                    <p>{props.body}</p>
                </div>
            </div>
