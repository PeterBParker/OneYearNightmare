...
export default function ReadPageCards(props) {
    ...
    return (
        props.isDesktop ? <DesktopReadPageCards page={props.page} chapter={props.chapter} page_uuid={page_uuid} comments={comments}/> : <MobileReadPageCards page={props.page} chapter={props.chapter} comments={comments} page_uuid={page_uuid}/>
    )
};
