        ...
        <div>
            ...
            <div className={`headerGridDesktop items-center w-full`}>
                <div className="headerContentDesktop flex flex-row items-center justify-center ">
                    <div className={`publishDaysDesktop text-mocha-dark self-center desktopHeaderLogoWingData desktopHeaderUpdateSchedule self-center font-medium justify-self-end mr-6 text-md flex-shrink-0`}>
