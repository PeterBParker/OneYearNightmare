...
export default function SupportMobile() {
    ...
    return(
        <div className="supportPage">
            ...
            <IconCard icon={patreonIcon} title="Patreon" body={patreonBody} link="https://www.patreon.com/" linkText="join the gang" isDesktop={false}/>
            <IconCard icon={buyUsACoffeeIcon} title="Buy Us a Coffee" body={buyusacoffeeBody} link="https://www.buymeacoffee.com/rayell" linkText="feed us, pls" isDesktop={false} />
        </div>
    );
}