...
export default function DesktopSupportUsCard(props) {
  ...
  if (bigEnough) {
    supportImageContainer = (
      <div className="tipJarIllo supportUsTipJar self-end pb-20">
        <a href="https://www.buymeacoffee.com/nate_and_mo">
          <img src={props.supportImage} width={"100%"} alt="tip jar button" />
        </a>
      </div>
    );
  }
  return (
    <div
      className={` ${
        bigEnough ? "supportUsBigEnoughContainer" : "supportUsTooSmallContainer"
      } desktopSupportUsContainer supportUsContainer mb-6`}
    >
      ...
      <div className="iconList supportUsCardLinks flex flex-row px-6 pb-4 items-end">
        <div className="patreonLink mr-4">
          <a href="https://www.patreon.com/nate_and_mo">
            <img
              src={props.patreonIcon}
              onMouseOver={() => props.changePatreon(props.patreonActive)}
              onMouseLeave={() => props.changePatreon(props.patreonInactive)}
              width={50}
              alt="patreon link"
            />
          </a>
        ...
        <div className="bmacLink mr-2">
          <a href="https://www.buymeacoffee.com/nate_and_mo">
            <img
              src={props.tipIcon}
              onMouseOver={() => props.changeTip(props.tipActive)}
              onMouseLeave={() => props.changeTip(props.tipInactive)}
              width={50}
              alt="tip link"
            />
          </a>
